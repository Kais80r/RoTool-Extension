...
function runRealChromiumTemplateParserRegression() {
  ...
  const fixtureSource = [
    ...
    "firstHelp.focus(); ensure(firstHelp.getAttribute('aria-expanded') === 'true' && !probeRoot.getElementById(firstHelp.getAttribute('aria-controls')).hidden, 'focus must open help');",
    ...
    "secondHelp.focus(); ensure(firstHelp.getAttribute('aria-expanded') === 'false' && secondHelp.getAttribute('aria-expanded') === 'true', 'opening one help tip must close another');",
